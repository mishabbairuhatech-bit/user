...
const variantStyles = {
  ...
  default: {
    soft: 'bg-gray-100 text-gray-700 border-gray-200 dark:bg-[#2a2a2a] dark:text-gray-300 dark:border-[#424242]',
    outline: 'bg-white text-gray-700 border-gray-300 dark:bg-[#121212] dark:text-gray-300 dark:border-[#424242]',
    filled: 'bg-gray-600 text-white border-gray-600 dark:bg-[#424242] dark:border-[#424242]',
    dot: 'bg-gray-500',
  },
  primary: {
    ...
    outline: 'bg-white text-primary-600 border-primary-300 dark:bg-[#121212] dark:text-primary-400 dark:border-primary-700',
  ...
  success: {
    ...
    outline: 'bg-white text-emerald-600 border-emerald-300 dark:bg-[#121212] dark:text-emerald-400 dark:border-emerald-700',
  ...
  warning: {
    ...
    outline: 'bg-white text-amber-600 border-amber-300 dark:bg-[#121212] dark:text-amber-400 dark:border-amber-700',
  ...
  danger: {
    ...
    outline: 'bg-white text-red-600 border-red-300 dark:bg-[#121212] dark:text-red-400 dark:border-red-700',
  ...
  info: {
    ...
    outline: 'bg-white text-blue-600 border-blue-300 dark:bg-[#121212] dark:text-blue-400 dark:border-blue-700',
  ...
  teal: {
    ...
    outline: 'bg-white text-teal-600 border-teal-300 dark:bg-[#121212] dark:text-teal-400 dark:border-teal-700',
  ...
  purple: {
    ...
    outline: 'bg-white text-purple-600 border-purple-300 dark:bg-[#121212] dark:text-purple-400 dark:border-purple-700',
  ...
  pink: {
    ...
    outline: 'bg-white text-pink-600 border-pink-300 dark:bg-[#121212] dark:text-pink-400 dark:border-pink-700',
