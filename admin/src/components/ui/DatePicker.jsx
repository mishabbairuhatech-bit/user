  ...
  return (
    <div className="w-full" ref={containerRef}>
      ...
      >
        ...
        {isOpen && !disabled && (
          <div className={`absolute z-50 top-full mt-1 bg-white dark:bg-[#1f1f1f] border border-gray-200 dark:border-[#424242] rounded-xl shadow-xl p-3 w-[280px] ${alignRight ? "right-0" : "left-0"}`}>
