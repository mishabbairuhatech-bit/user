...
const balanceTypeOptions = [
  ...
  { value: 'debit', label: 'Debit (Advance)' },
];

const VendorCreateForm = ({ onClose }) => {
  ...
  const onSubmit = (data) => {
    ...
    if (data.opening_balance) {
      payload.opening_balance = parseFloat(data.opening_balance) || 0;
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="flex items-center justify-between px-5 py-3 border-b border-gray-200 dark:border-[#424242] flex-shrink-0">
        <h3 className="text-sm font-semibold text-gray-900 dark:text-white">Create Vendor</h3>
        <button
          onClick={() => navigate('/admin/purchases/vendors/create')}
